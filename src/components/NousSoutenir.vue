<template>
    <div class="container-fluid welcome">
        <div class="row text-center justify-content-center">
            <div class="col-12">
                <h1 class="display-5" style="text-transform: uppercase">Nous Soutenir</h1>
            </div>
            ...
            <div class="col-12 content-top">
                <div class="row text-center justify-content-center align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 text-lg-center text-md-center text-md-center">
                        <img src="../assets/img/mentor.jpg" class="img-border i m-3" alt="">
                    </div>
                    ...
                    <div class="col-12">
                        <div class="row text-center justify-content-center align-items-center">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 text-lg-center text-md-center text-md-center">
                                <img src="../assets/img/coach.png" class="img-border i m-3" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row text-center justify-content-center align-items-center">
            ...
            <div class="col-12 my-4">
                <h1 class="blue" style="font-weight: normal">Pourquoi faire un don à la fondation e-mtiyaz ?</h1>
            </div>
        </div>
...
<style lang="scss" scoped>
    ...
    .jumbotron {
        background: linear-gradient(175deg, $light-green-color, $dark-green-color);
        transition: 1s ease;
        margin-bottom: 3rem;
        margin-top: 3rem;
    }
    ...
    .jumbotron:hover {
        background: linear-gradient(185deg, $light-green-color, $dark-green-color);
    }
    .orange{
